...
async function callGemini(promptText) {
  ...
  // Google Gemini multi-model fallback list to guarantee high availability
  const models = ["gemini-3.5-flash", "gemini-3.1-flash-lite", "gemini-2.5-flash-lite", "gemini-2.0-flash"];
  const errors = [];
